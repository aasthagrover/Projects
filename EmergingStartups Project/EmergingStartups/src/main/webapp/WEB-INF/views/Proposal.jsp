    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <p> <div align="center" style="color:white;">
        <h3>List Of Proposals made by Entrepreneur</h3>
<table id='minetable' border="1">
            <tr>
                <th>Investor Name</th>
 ...
 <tr>
    <td><c:out value="${f.investorName}"></c:out></td>
    <td><c:out value="${f.investorContact}"></c:out></td>
 </tr>
 </c:forEach>
 </table>
                </div></p>
