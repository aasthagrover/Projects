        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <p> <div align="center" style="color:silver;">
                   <h1>Notifications</h1>
<h3>Approved Proposal Requests</h3>

<input type="hidden" id="userID" name="entrepreneurUserID" value="${requestScope.userID}"/>
<table>
		<tr>
		   <th>Approved By Investor</th>       
		</tr>
		<c:forEach var="f" items="${requestScope.list}">
		<tr>
          <form action="pdf.htm" method="POST">
		<td><input type="text" name="investorName" value="${f.investor.investorName}"/></td>
		 <td><input type="text" name="selfInvestmentShare" value="${f.selfInvestmentShare}"/></td>
		<td><input type="hidden" name="userID" value="${f.investor.userID}"/>
		<td><input type="hidden" name="action" value="EntrepreneurContract"/>
		<td><input type="submit" value="SeeContract" /></td>
		</form>
		</tr>
 </c:forEach>
</table>
