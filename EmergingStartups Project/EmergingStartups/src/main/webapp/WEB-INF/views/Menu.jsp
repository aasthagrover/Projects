    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
               ...
               <h2 align="center"> <a class="navbar-brand page-scroll" href="#page-top">Rise</a></h2>
            </div>
        ...
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <p> <div align="center" style="color:silver;">
						...
						<form id="signIn" action="signIn.htm" method="post" >
						<table>  
						    <tr>
						     <td>UserName:</td>  
						    ...
						    <tr> 
						      ...
						      <td><input type="hidden" name="action" value="login"></input></td> 
						      <td><input type="submit" value="Sign In"></input></td>  
						      <td><a href="signIn.htm?action=forgot">Forgot Your Password?</a></td> 
						    </tr>
						    <tr>
						      <td>  
						          <c:if test="${!empty requestScope.Error}">
						           <p style="color:red"><c:out value="${requestScope.Error}"></c:out></p>
						            </c:if>
						        </td>
						      
						        <td><p>${requestScope.message}</p></td>
						    </tr>
						 </table>
						</form> 
